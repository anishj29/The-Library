...
(async() => {
  ...
  prompt.get(schema, (err, result) => {
    ...
    const filesToRelocate = [
      ...
      [path.resolve(__dirname, '../lib/core/AndroidContentPartRetriever.chunk.js'), `${resourceDir}/lib/core/`, true],
      [path.resolve(__dirname, '../lib/core/ArrayBufferPdfPartRetriever.chunk.js'), `${resourceDir}/lib/core/`, true],
      [path.resolve(__dirname, '../lib/core/AzurePartRetriever.chunk.js'), `${resourceDir}/lib/core/`, true],
      [path.resolve(__dirname, '../lib/core/BlackBoxPartRetriever.chunk.js'), `${resourceDir}/lib/core/`, true],
      [path.resolve(__dirname, '../lib/core/ExternalPdfPartRetriever.chunk.js'), `${resourceDir}/lib/core/`, true],
      [path.resolve(__dirname, '../lib/core/HttpPartRetriever.chunk.js'), `${resourceDir}/lib/core/`, true],
      [path.resolve(__dirname, '../lib/core/IOSPartRetriever.chunk.js'), `${resourceDir}/lib/core/`, true],
      [path.resolve(__dirname, '../lib/core/LocalPartRetriever.chunk.js'), `${resourceDir}/lib/core/`, true],
      [path.resolve(__dirname, '../lib/core/LocalPdfPartRetriever.chunk.js'), `${resourceDir}/lib/core/`, true],
      ...
      [path.resolve(__dirname, '../lib/core/StreamingPartRetriever.chunk.js'), `${resourceDir}/lib/core/`, true],
      [path.resolve(__dirname, '../lib/core/WebDBPartRetriever.chunk.js'), `${resourceDir}/lib/core/`, true],
      [path.resolve(__dirname, '../lib/core/WinRTPartRetriever.chunk.js'), `${resourceDir}/lib/core/`, true],
